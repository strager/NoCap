namespace Bindable.Linq.Aggregators
{
    ...
    internal sealed class MinAggregator<TValue, TAverageResult> : Aggregator<TValue, TValue>
    {
        private readonly INumeric<TValue, TAverageResult> _numericHelper;

        /// <summary>
        /// Initializes a new instance of the <see cref="MinAggregator&lt;TValue, TAverageResult&gt;"/> class.
        /// </summary>
        /// <param name="sourceCollection">The source collection.</param>
        /// <param name="numericHelper">A numeric helper.</param>
        public MinAggregator(IBindableCollection<TValue> sourceCollection, INumeric<TValue, TAverageResult> numericHelper)
        ...
        {
            Current = _numericHelper.Min(SourceCollection);
        }
    }
}